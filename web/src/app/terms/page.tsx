      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-6">
          <SectionCard number={1} title="Acceptance of Terms" delay={50}>
            <p>
              By accessing or using Retenio (&quot;the Service&quot;), you agree
          ...
          <SectionCard number={2} title="Description of Service" delay={100}>
            <p>
              Retenio is a Chrome extension and web application that helps users
              learn from YouTube videos by generating summaries and interactive
              quizzes using artificial intelligence.
            </p>
          </SectionCard>
          ...
          <SectionCard number={5} title="Intellectual Property" delay={250}>
            <p>
              ...
              are owned by Retenio and are protected by international copyright,
          ...
          <SectionCard number={9} title="Limitation of Liability" delay={450}>
            <p className="uppercase">
              IN NO EVENT SHALL RECALLAI BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
          ...
          <SectionCard number={11} title="Changes to Terms" delay={550}>
            <p>
              ...
              notify users of material changes by posting the new Terms on this
