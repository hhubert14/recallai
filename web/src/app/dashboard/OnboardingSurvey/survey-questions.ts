...
export const SURVEY_QUESTIONS: SurveyQuestionConfig[] = [
    {
        ...
        options: [
            ...
            { value: "personal_growth", label: "Explore new topics for personal growth" },
    ...
    },
    {
        ...
        options: [
            ...
            { value: "business_pro", label: "Business Professional" },
            { value: "entrepreneur", label: "Small Business Owner/Entrepreneur" },
            { value: "trainer", label: "Corporate Trainer/L&D Specialist" },
            { value: "lifelong_learner", label: "Lifelong Learner/Hobbyist" },
        ],
        showOther: true,
    },
    {
    ...
    {
        id: "videoFrequency",
        question: "How often do you watch educational videos on YouTube?",
        options: [
    ...
    },
    {
        ...
        question: "Which of the following features are you most interested in?",
        options: [
            { value: "qa_generation", label: "Automatic Q&A generation" },
            { value: "spaced_repetition", label: "Spaced repetition review" },
            { value: "progress_tracking", label: "Progress tracking" },
            { value: "integrations", label: "Integration with other tools" },
        ],
        multiSelect: true,
        showOther: true,
    },
    ...
    },
    {
        ...
        options: [
            { value: "high_school", label: "High school or lower" },
    ...
    {
        id: "willingToBeta",
        question: "Would you be willing to participate in beta testing or feedback groups?",
        options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
