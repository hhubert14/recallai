      ...
      <main className="flex-1 container py-4 px-6 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground mt-1">{joinDate}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-muted-foreground">
                Install the Retenio Chrome extension to automatically process
                educational YouTube videos. Once installed, simply sign in to
                Retenio in your browser, and the extension will automatically
                connect.
              </p>
              <a
              ...
              <p className="text-sm text-muted-foreground">
                After installing, sign in to Retenio and the extension will
                automatically work with your account. No manual token
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-muted-foreground">
                Need help? Have a question, found a bug, or want to request a
                feature? Get in touch with our support team.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a
