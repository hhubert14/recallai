...
import { BookOpen, ArrowRight, Plus, FolderPlus, MoreVertical, ArrowLeft } from "lucide-react";
        ...
        return (
            <div className="rounded-lg border border-dashed border-border p-8 text-center">
                ...
                {isViewingFolder ? (
                    ...
                    <>
                        <p className="text-sm text-muted-foreground mb-4">
                            No study sets yet. Create your own or install the Chrome extension to
                            generate study sets from YouTube videos.
                        </p>
