...
import {
  useAISuggestionReview,
  type EditedSuggestionContent,
} from "@/hooks/useAISuggestionReview";
...
const PROMPT_SUGGESTIONS = [
  ...
  { label: "Main ideas", prompt: "Main ideas and takeaways from this video" },
  {
    ...
    prompt: "Test my understanding of the key concepts",
  },
  {
    label: "Important facts",
    prompt: "Important facts to remember from this video",
  },
];
...
export function AIGenerateModal({
      ...
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Describe what you want to learn and AI will generate flashcards
  ...
  // Render review phase
  const isAnyAccepting = review.suggestions.some((s) =>
    review.isAccepting(s.tempId)
  );
  return (
    <LoadingAwareDialog
      open={isOpen}
        ...
        <div className="flex-1 overflow-y-auto space-y-4 py-4">
          {review.suggestions.map((suggestion) => (
            <SuggestionCard
              ...
              editedContent={
                review.editState.tempId === suggestion.tempId
                  ? review.editState.content
                  : {}
              }
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <CharacterCount
              current={(editedContent.front || "").length}
              max={CHARACTER_LIMITS.flashcardFront}
            />
          </div>
          <Textarea
            id="edit-front"
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <CharacterCount
              current={(editedContent.back || "").length}
              max={CHARACTER_LIMITS.flashcardBack}
            />
          </div>
          <Textarea
            id="edit-back"
...
function QuestionSuggestionCard({
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <CharacterCount
              current={(editedContent.questionText || "").length}
              max={CHARACTER_LIMITS.questionText}
            />
          </div>
          <Textarea
            id="edit-question"
        ...
        <div className="space-y-2">
          ...
          {(editedContent.options || suggestion.options).map(
            (option, index) => (
              <div key={index} className="flex items-center gap-2">
                <button
                  ...
                  onClick={() => {
                    const currentOptions =
                      editedContent.options || suggestion.options;
                ...
                />
                <CharacterCount
                  current={option.optionText.length}
                  max={CHARACTER_LIMITS.optionText}
                />
              </div>
            )
          )}
  ...
  return (
    ...
    >
      ...
      <div>
        <AIContent
          content={suggestion.questionText}
