...
export function PracticeModal({
  ...
  const selectedConcept =
    selectedConceptIndex !== null ? concepts[selectedConceptIndex] : null;
  ...
  const isAnyLoading =
    phase === "grouping" || chat.isSending || isLoadingFeedback;
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {phase === "concept-selection" && (
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">Choose a Concept</p>
            <RadioGroup
              value={
