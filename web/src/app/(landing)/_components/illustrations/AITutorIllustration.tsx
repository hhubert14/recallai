...
export function AITutorIllustration({
  className = "",
}: AITutorIllustrationProps) {
  return (
    <svg
      viewBox="0 0 300 200"
      fill="none"
    ...
    >
      ...
      <g transform="translate(70, 80)">
        <path d="M0 20 L10 15 L10 25 Z" className="fill-foreground/5" />
        <rect
          x="10"
          y="0"
          width="90"
      ...
      <g transform="translate(220, 40)">
        ...
        {/* Brain detail lines */}
        <path
          d="M30 18 Q28 25 30 32"
          className="stroke-foreground/20"
          strokeWidth="1"
          fill="none"
        />
        <path
          d="M24 22 Q30 24 36 22"
          className="stroke-foreground/20"
          strokeWidth="1"
          fill="none"
        />
        ...
        {/* Sparkles around AI */}
        <path
          d="M55 15 L57 20 L62 18 L58 22 L63 25 L57 24 L55 30 L53 24 L47 25 L52 22 L48 18 L53 20 Z"
          className="fill-foreground/30"
        />
        <path
          d="M5 50 L6 53 L9 52 L7 54 L10 56 L6 55 L5 58 L4 55 L0 56 L3 54 L1 52 L4 53 Z"
          className="fill-foreground/20"
        />
      </g>
      ...
      <g transform="translate(130, 100)">
        <rect
          ...
          strokeWidth="1"
        />
        <path d="M130 25 L140 30 L130 35 Z" className="fill-foreground/5" />
        ...
        <g transform="translate(10, 45)">
          ...
          />
          <path
            d="M7 18 L13 18 M8 20 L12 20"
            className="stroke-foreground/20"
            strokeWidth="1"
          />
          {/* Light rays */}
          <path
            d="M10 0 L10 -3 M3 3 L1 1 M17 3 L19 1 M0 10 L-3 10 M20 10 L23 10"
