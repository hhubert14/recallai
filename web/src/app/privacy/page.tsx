                ...
                <div className="space-y-6">
                    <SectionCard number={1} title="Introduction" delay={50}>
                        <p>
                            ...
                            you use our Chrome extension and web application.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard number={3} title="How We Use Your Information" delay={150}>
                    ...
                    <SectionCard number={4} title="Data Storage and Security" delay={200}>
                        <p className="mb-3">
                            Your data is stored securely using Supabase, a trusted
                            cloud database provider. We implement industry-standard
                    ...
                    <SectionCard number={9} title="Children's Privacy" delay={450}>
                        <p>
                            ...
                            from children under 13. If you become aware that a child
                            has provided us with personal information, please contact
                            us immediately.
                        </p>
                    </SectionCard>

                    <SectionCard number={10} title="International Data Transfers" delay={500}>
                        <p>
                            Your data may be transferred to and processed in countries
                            other than your own. We ensure appropriate safeguards are
                            in place to protect your data in accordance with applicable
                            privacy laws.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard number={11} title="Changes to This Policy" delay={550}>
                        <p>
                            ...
                            use of our service after changes become effective constitutes
                    ...
                    <div className="pt-8 border-t border-border animate-fade-up" style={{ animationDelay: '650ms' }}>
