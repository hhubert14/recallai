...
describe("DeleteFlashcardUseCase", () => {
    ...
    it("deletes a flashcard belonging to the user", async () => {
        ...
        vi.mocked(mockFlashcardRepository.findFlashcardById).mockResolvedValue(flashcard);
        vi.mocked(mockFlashcardRepository.deleteFlashcard).mockResolvedValue(undefined);
