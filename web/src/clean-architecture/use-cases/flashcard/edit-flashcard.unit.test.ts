...
describe("EditFlashcardUseCase", () => {
    ...
    it("updates a flashcard successfully", async () => {
        ...
        expect(mockFlashcardRepository.findFlashcardById).toHaveBeenCalledWith(flashcardId);
    ...
    it("throws error when flashcard does not exist", async () => {
        vi.mocked(mockFlashcardRepository.findFlashcardById).mockResolvedValue(null);
    ...
    it("throws error when user does not own the flashcard", async () => {
        ...
        vi.mocked(mockFlashcardRepository.findFlashcardById).mockResolvedValue(otherUserFlashcard);
