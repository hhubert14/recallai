...
class Logger {
    ...
    extension = {
        ...
        info: (message: string, context?: LogContext) => {
            ...
            if (message.includes('Processing') || message.includes('completed') || message.includes('failed')) {
    ...
    video = {
        ...
        info: (message: string, context?: LogContext) => {
            ...
            if (message.includes('processed') || message.includes('completed') || message.includes('failed')) {
    ...
    subscription = {
        ...
        info: (message: string, context?: LogContext) => {
            ...
            if (message.includes('upgraded') || message.includes('downgraded') || message.includes('limit')) {
