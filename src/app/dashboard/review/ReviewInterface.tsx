            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg">
                        <p className="text-2xl font-bold text-blue-900 dark:text-blue-100">{reviewStats.questionsDueToday}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Due Today</p>
                    </div>
                    <div className="bg-green-50 dark:bg-green-950/20 p-4 rounded-lg">
                        <p className="text-2xl font-bold text-green-900 dark:text-green-100">{reviewStats.totalQuestionsInSystem}</p>
